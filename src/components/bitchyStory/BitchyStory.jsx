    ...
    <div className=" relative bg-[#39C6CB]">
      ...
      <div className="hidden md:block">
        ...
        <div
          ...
          style={{ marginBottom: "23%", marginLeft: "27%" }}
        >
          <Cliva />
        </div>
        <div>
        ...
        <div className=" flex justify-center">
          ...
          <div className=" absolute bottom-0 text-white  font-secondRegular text-center">
            <p
              className=" font-primaryRegular md:text-sm  uppercase "
              style={{ WebkitTextStroke: "1px #228EFD" }}
            >
      ...
      <div className="block md:hidden relative">
        ...
        <div className=" absolute top-0 ">
          ...
          <div
            className=" absolute top-4 text-white  font-secondRegular"
            style={{ lineHeight: "2", marginLeft: "4%" }}
          >
            <p
              className=" font-primaryRegular uppercase "
              style={{ WebkitTextStroke: "1px #228EFD" }}
            >
          ...
          <div
            className=" absolute top-0 text-white font-secondRegular text-sm capitalize"
            style={{ marginTop: "24%", marginLeft: "4%" }}
          >
        ...
        <div className=" absolute top-0 " style={{ marginTop: "70%" }}>
          ...
          >
            ...
            <div
              className="text-[#FF0A0A]  pt-4 capitalize"
              style={{ lineHeight: "2" }}
            >
