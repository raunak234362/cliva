  ...
  return (
    <div className=" relative bg-[#4BB149] h-fit">
      ...
      <div className="hidden md:block">
        <div
          className="text-[#EBE235] font-primaryRegular text-center md:text-xl uppercase text-[1rem] font-bold mt-2 pt-10  p-5 pb-10"
          style={{ WebkitTextStroke: "1px #F39734", lineHeight: "2" }}
        >
          bitchy plan.. Roadmap!
        </div>
        <div
          className=" absolute md:w-[50%] h-full "
          style={{
        ...
        <div className=" absolute top-0" style={{ marginTop: "-5%" }}>
          <img src={LeftFlower} alt="" className=" w-[20%] z-100" />
        </div>
        ...
        <div className="relative">
          ...
          />
          <div
            className="text-[#EBE235] font-primaryRegular absolute top-10 left-0 text-center md:text-md uppercase text-sm font-bold pb-10"
          ...
          <div
            className=" absolute top-0 text-sm font-secondRegular text-[#97E996]"
